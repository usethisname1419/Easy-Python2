...
def create_envs(base_path, py3_env, py2_env, python3_path="python3", python2_path="python2"):
    ...
    py2_env_path = os.path.join(base_path, py2_env)
    ...
    # Step 3: Use virtualenv to create a Python 2 virtual environment
    ...
    print(f"Success! Python 3 virtual environment '{py3_env_path}' and Python 2 virtual environment '{py2_env_path}' are ready.")
